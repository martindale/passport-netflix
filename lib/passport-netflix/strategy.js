...
function Strategy(options, verify) {
  options = options || {};
  options.requestTokenURL = options.requestTokenURL || 'http://api-public.netflix.com/oauth/request_token';
  options.accessTokenURL = options.accessTokenURL || 'http://api-public.netflix.com/oauth/access_token';
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  ...
  this._oauth.get('http://api-public.netflix.com/users/' + params.user_id, token, tokenSecret, function (err, body, res) {
